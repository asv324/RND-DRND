...
from model_DRND import CnnActorCriticNetwork, DRNDModel
from utils_DRND import global_grad_norm_
    ...
    def train_model(self, s_batch, target_ext_batch, target_int_batch, y_batch, adv_batch, next_obs_batch, old_policy):
        ...
        for i in range(self.epoch):
            ...
            for j in range(int(len(s_batch) / self.batch_size)):
                ...
                # + 1e-8 is for numerical stability (NOT IN RND)
                ...
                # CALCULATE THE LOSS
                # Total loss = Policy gradient loss - entropy * entropy coefficient + Value coefficient * value loss + forward_loss + drnd_loss
        ...
        return total_actor_loss / num_batches, total_critic_loss / num_batches, total_entropy / num_batches, total_forward_loss / num_batches, total_total_loss / num_batches
